...
//   return (
//     <FooterBody isMainPage={isMainPage}>
...
//   position: ${props => (props.isMainPage ? "fixed" : "relative")};
//   bottom: ${props => (props.isMainPage ? "0" : "auto")};
//   left: ${props => (props.isMainPage ? "0" : "auto")};
//   margin-top: auto;
...
const Footer = () => {
  ...
  // 경로가 "/" 또는 "/NCA"인 경우 스타일을 고정하도록 설정
  const isFixedStyle =
    location.pathname === "/" || location.pathname === "/NCA";

  return (
    <FooterBody isFixedStyle={isFixedStyle}>
      <div className="introduce-box">
        <p className="introduce-text">
          이 사이트는 네이버 클라우드 공식 웹사이트와 관련이 없습니다.
          <br />
